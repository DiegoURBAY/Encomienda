        ...
        if(identificador !==null && identificador.length !== 0){
            if(identificador.length <= 8 && identificador.length > 0){
                ...
                if(mes !== null){
                    ...
                    titulo = "Reporte de cantidad de encomiendas realizadas por tipo de cliente según el tipo desde "+fecha_inicio+" hasta "+fecha_final+" del DNI "+identificador;
                }
            }else  if(identificador.length > 8){
                if(mes !== null){
                ...
                titulo = "Reporte de cantidad de encomiendas realizadas por tipo de cliente según el tipo desde "+fecha_inicio+" hasta "+fecha_final+" del RUC "+identificador;
                }
            }
